...
Does changing the representational perspective provide a computational advantage for creative problem solving compared with searching within a fixed representation?
...
**Perspective** is a task-dependent contextual state that changes at least one of: feature weighting, relational structure, transition dynamics, or readout. Merely adding an unrelated input does not count.
...
The strongest initial evidence would combine: (1) a controlled behavioral or computational advantage over the alternatives above; (2) a perspective-specific geometric change preceding solution; and (3) mediation or intervention evidence linking that change to success. A performance gain without a geometric or dynamical signature would support a weaker switching account, not the full theory.
